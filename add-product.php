...
if(isset($_POST['insert'])) {
	...
	$lacation = "images/".$image_name;
	move_uploaded_file($image_tmp_name, $lacation);
	
	$sql = "INSERT INTO product(product_id, product_name, product_category, product_image, product_price, product_description, product_availability, product_seller_id) 
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-9">
						...
						<h1>Add Product</h1>
						<form method="POST" action="add-product.php" enctype="multipart/form-data" class="contact-form">
