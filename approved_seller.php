								...
								<?php 
									...
									if($query_run = mysql_query($query)) {
										while($query_rows = mysql_fetch_assoc($query_run)) {
											$sid = $query_rows['approved_seller_id'];
											$sname = $query_rows['approved_seller_name'];
											$semail = $query_rows['approved_seller_email'];
											$scontact = $query_rows['approved_seller_contact_no'];
											
											
											echo '<tr style="text-align:center">';
											echo '<td>'.$sname.'</td><td>'.$semail.'</td><td>'.$scontact.'</td>';
											echo '<td><a href="approved_seller.php?del_id='.$sid.'">Delete</a></td>';
											echo '</tr>';
