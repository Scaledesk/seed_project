		                    ...
		                    <div class="row">
		                    	<div class="col-sm-12">
		                    		<div class="blog-post">
										...
										<div class="col-sm-12">
										<div class="col-sm-12">
										<h1 style="margin-bottom:20px;">Bank Details</h1>
										...
										$sql_show = "SELECT name, bank_name, branch_name,account_number,ifsc_code FROM bank_details";
										if($sql_show_run = @mysql_query($sql_show)) {
											while($sql_show_rows = mysql_fetch_assoc($sql_show_run)) {
													
													$name = $sql_show_rows['name'];
													$bank_name = $sql_show_rows['bank_name'];
													$branch_name = $sql_show_rows['branch_name'];
													$account_number = $sql_show_rows['account_number'];
													$ifsc_code = $sql_show_rows['ifsc_code'];
													
										
													echo '<tr style="text-align:center;"><td>'.$name.'</td><td>'.$bank_name.'</td><td>'.$branch_name.'</td><td>'.$account_number.'</td><td>'.$ifsc_code.'</td></tr>'; 
