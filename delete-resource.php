...
if(isset($_GET['del_id'])) {
	...
	$sql_del = "DELETE FROM resources WHERE id='$delete_id'";
	
	if(mysql_query($sql_del)) {

		header("location: delete-resource.php?msg=Data Deleted Successfully ");
		                    ...
		                    <div class="row">
		                    	<div class="col-sm-12">
		                    		<div class="blog-post">
										...
										<div class="row">
										<div class="col-sm-12">
											<h1 style="margin-bottom:20px;">Delete Resource</h1>
											...
											<?php
												...
												if($query_run = mysql_query($query)) {
													while($query_rows = mysql_fetch_assoc($query_run)) {
														...
														echo '<tr><td>'.$title.'</td><td>'.$detail.'</td><td><a href="delete-resource.php?del_id='.$id.'">Delete</a></td></tr>'; 
