                	...
                	<div class="col-md-8">
                		<div class="main-content blog">
		                    <div class="row">
		                    	<div class="col-sm-12">
		                    		<?php 
										$sql_show = "SELECT i.industries_name, i.industries_description, i.industries_states_id, s.states_name FROM industries i, states s WHERE i.industries_states_id = s.states_id";
										if($sql_show_run = @mysql_query($sql_show)) {
											while($sql_show_rows = mysql_fetch_assoc($sql_show_run)) {
												$state_id = $sql_show_rows['industries_states_id'];
												$in_name = $sql_show_rows['industries_name'];
												$in_description = $sql_show_rows['industries_description'];
												$in_states = $sql_show_rows['states_name'];
												...
												echo '
														<div class="blog-post">
															...
															<div class="blog-content">
																<div class="blog-meta">
																	<span><b>State: </b>'.$in_states.'</span>
																</div>
																<h4><a href="blog-single.html">'.$in_name.'</a></h4>
