                		...
                		<div class="main-content blog">
		                    <div class="row">
		                    	<div class="col-sm-12" style="padding-top:25px;">
		                    		<div class="blog-post">
										<h1 style="margin-bottom:25px;">Delete Category</h1>
										<table border="1" style="width:100%;">
										<th style="text-align:center;">Category Name</th>
										<th style="text-align:center;">Action</th>
										<?php
											$sql_cat = "SELECT cat_id, category FROM category";
											if($sql_cat_run = mysql_query($sql_cat)) {
												while($sql_cat_rows = mysql_fetch_assoc($sql_cat_run)) {
													$category_id = $sql_cat_rows['cat_id'];
													$category = $sql_cat_rows['category'];
													
													echo '<tr style="text-align:center;"><td>'.$category.'</td><td><a href="delete_category.php?del_id='.$category_id.'">Delete</a></td></tr>';
												}
											} else {
												echo mysql_query();
											}
