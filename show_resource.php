                	...
                	<div class="col-md-8">
                		<div class="main-content blog">
		                    <div class="row">
		                    	<div class="col-sm-12">
		                    		<?php 
										$sql_show = "SELECT title, detail, timestamp FROM resources";
										if($sql_show_run = @mysql_query($sql_show)) {
											while($sql_show_rows = mysql_fetch_assoc($sql_show_run)) {
													
													$title = $sql_show_rows['title'];
													$detail = $sql_show_rows['detail'];
													$time = $sql_show_rows['timestamp'];
													
													$splite_time = explode(",", $time);
												...
												echo '
													<div class="blog-post">
														<div class="blog-content">
															<div class="blog-meta">
																<span><a href="#"><i class="fa fa-clock-o"></i>'.$time.'</a></span>
																<span><a href="#"><i class="fa fa-calendar-o"></i>'.$date.'</a></span>
