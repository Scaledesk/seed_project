...
<section class="services">
	...
	<h1>Seller Pending Product</h1><br /><br />
...
<?php 
	...
	$query = "SELECT * FROM product WHERE product_seller_id='$seller_p_id'";
	...
	if($query_run = mysql_query($query)) {
		while($query_rows = mysql_fetch_assoc($query_run)) {
			...
			echo '<td><a href="seller_pending_product.php?del_id='.$id.'">Delete</a></td>';
			echo '</tr>';
