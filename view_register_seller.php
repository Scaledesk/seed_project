					...
					<div class="col-md-9">
                		<div class="main-content blog">
		                    <div class="row">
								...
								<?php 
									$query = "SELECT seller_registration_id, seller_registration_email, seller_registration_name, seller_registration_contact_no FROM seller_registration";
									
									if($query_run = mysql_query($query)) {
										while($query_rows = mysql_fetch_assoc($query_run)) {
											$sid = $query_rows['seller_registration_id'];
											$sname = $query_rows['seller_registration_name'];
											$semail = $query_rows['seller_registration_email'];
											$scontact = $query_rows['seller_registration_contact_no'];
											
											
											echo '<tr style="text-align:center">';
											echo '<td><input type="checkbox" name="appr[]" value="'.$sid.'"></td>';
											echo '<td>'.$sname.'</td><td>'.$semail.'</td><td>'.$scontact.'</td>';
