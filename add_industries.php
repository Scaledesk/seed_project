			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-9">
							...
							<form method="POST" action="add_industries.php" class="contact-form">
								<div class="form-group">
								<div class="row">
								<div class="col-md-6 col-sm-6">
								Select States :- 
								<select name="indust_id" style="width:100%;margin-bottom:25px;padding:14px;">
								...
								<div class="col-md-6 col-sm-6">
								Enter Industry Detail :- 
								<textarea cols="50" rows="5" name="detail"></textarea>
								
								
								</div>
								<div class="col-md-12 col-sm-12"><input type="submit" value="Submit" name="submit" class="btn btn-accent" style="width:25%;"></div>
								</div>
								</div>
							</form>
